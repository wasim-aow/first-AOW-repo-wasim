    ...
    return (
        <>
            ...
            <section className="w-full bg-white py-8">
                <div className="max-w-7xl mx-auto px-6 md:px-[100px] grid md:grid-cols-3 gap-6 auto-rows-min">
                    <div className="group bg-white overflow-hidden hover:bg-[#00418d] transition-all duration-500 p-6 rounded-lg shadow-lg flex flex-col items-center text-center h-[300px] hover:h-fit cursor-pointer">
                        <Image
                        ...
                        <p className="opacity-0 group-hover:opacity-100 group-hover:mt-4 transition-opacity duration-500 text-sm text-[#272727] group-hover:text-white text-center cursor-pointer">
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="flex flex-col md:flex-row gap-10 items-center md:items-start">
                        ...
                        <div className="w-full md:w-1/3 flex justify-center md:justify-start">
                            <div className="relative md:w-[350px] md:h-[350px] w-[250px] h-[250px]">
                                <Image
                                    src="/images/aboutpage/Venugopal.png"
                                    alt="Venugopal B A - CEO"
                                    fill
                                    className="rounded-full object-cover border-[5px] border-[#f73e5d]"
                                />
                                <p className="text-sm text-gray-500 mt-3 text-center md:text-center italic absolute md:bottom-[-30px] md:left-[30%] bottom-[-30px] left-[20%]">
                                    CEO, SkillKwiz
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="w-full md:w-2/3 text-center md:text-left">
                            <p className="text-[#272727] mb-6 leading-relaxed text-lg">
                                <span className="font-semibold text-[#f73e5d]">Venugopal B A</span>, a veteran leader in the IT industry with
                            ...
                            <p className="text-[#272727] leading-relaxed text-lg">
                                With a rich background in the technology industry, he aims to
                                establish SkillKwiz as an AI-first company. He is poised to take
                                SkillKwiz to its next level of growth by turning it into a company
