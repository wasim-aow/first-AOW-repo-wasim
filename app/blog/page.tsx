...
export default function BlogPage() {
  ...
  return (
    <section className="w-full bg-white py-16 mt-[50px]">
      <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {blogPosts.map((post, index) => (
              <div
                ...
                className="flex flex-col bg-[#f9faff] rounded-lg shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden group"
              >
                ...
                <div className="p-5">
                  <h3 className="text-lg font-bold mb-2 text-[#00418d]">
                    {post.title}
                  </h3>
                  <p className="text-sm text-[#093fb4] font-medium">
                    {post.subtitle}
                  </p>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
          <div className="flex flex-col bg-[#f9f9ff] rounded-lg shadow-md hover:shadow-lg transition-all duration-300 overflow-hidden">
            <Image
            ...
            />
            <div className="p-6">
              <h3 className="text-xl font-bold text-[#00418d] mb-2">
