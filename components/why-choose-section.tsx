    ...
    return (
        <section className="py-16 text-white relative overflow-hidden">
            ...
            <div className="max-w-6xl mx-auto px-6 relative z-10 ]">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center gap-4 mb-16 relative h-auto md:h-[400px] pt-[30px]">
                    {/* Skill Library Card - Tilted Left */}
                    <div
                        className="bg-white rounded-lg p-6 text-black max-w-xs w-full md:w-64 md:h-fit shadow-lg transition-all duration-300 hover:-translate-y-2 z-10 hover:z-30 
      md:absolute md:left-[calc(50%-380px)] md:top-4 md:-rotate-[25deg]"
                    >
                    ...
                    <div
                        className="bg-white rounded-lg p-6 text-black max-w-xs w-full md:w-64 md:h-fit shadow-lg transition-all duration-300 hover:-translate-y-2 z-20 
      md:absolute md:left-[calc(50%-200px)] md:rotate-[0deg]"
                    >
                        <div className="flex justify-center mb-4">
                            <div className="w-16 h-16 bg-[#c3dfff] rounded-full flex items-center justify-center overflow-hidden">
                                <img
                        ...
                        <p className="text-gray-700 text-center text-[15px]">
                            Our testing is done in secure content-aware environments. Candidates are
                            authenticated through multiple identification layers including biometric
                            verification such as facial recognition and ID validation.
                        </p>
                    </div>
                    ...
                    <div
                        className="bg-white rounded-lg p-6 text-black max-w-xs w-full md:w-64 md:h-fit shadow-lg transition-all duration-300 hover:-translate-y-2 z-10 hover:z-30 
      md:absolute md:right-[calc(50%-350px)] md:top-4 md:rotate-[25deg]"
                    >
                        <div className="flex justify-center mb-4">
                            <div className="w-16 h-16 bg-[#c3dfff] rounded-full flex items-center justify-center overflow-hidden">
                                <img
                        ...
                        <p className="text-gray-700 text-center text-[15px]">
                            Our pricing model is designed to scale with your needs. Pay only for what
                            you use with our credit-based system. Larger organizations can benefit
                            from our Enterprise plan.
                        </p>
                    </div>
                </div>
